...
- Always support both Isaac (Pixel 10 Pro / Android) and his wife (iPhone / iOS 16.4+ Safari PWA) for household filter maintenance.
- Maintain dual access options: Mobile PWA at http://192.168.86.47:3030 and OpenClaw WhatsApp assistant conversational queries.
- Support household member attribution on replacements and snooze actions.
